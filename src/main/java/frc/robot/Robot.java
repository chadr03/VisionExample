...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    EasyPathConfig config = new EasyPathConfig(
      drive, // the subsystem itself
      drive::tankDrive, // function to set left/right speeds
      // function to give EasyPath the length driven
      () -> PathUtil.defaultLengthDrivenEstimator(drive::leftEncoderInch, drive::rightEncoderInch),
      drive::getAngle, // function to give EasyPath the heading of your robot
      drive::zeroSensors, // function to reset your encoders to 0
